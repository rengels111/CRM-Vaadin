...
// Die @Attribute(name = "class", contains = "login-view") Annotation ermöglicht es uns, ein bestimmtes LoginViewElement
// mithilfe der TestBench Query API zu finden, in diesem Fall über den CSS-Klassennamen.
